...
<asp:Content ID="Content3" ContentPlaceHolderID="SidebarContent" runat="server">
    ...
    <h2 class="sidebar-section-title">HOẠT ĐỘNG</h2>
    <asp:Button ID="BtnWishlist" runat="server" Text="Sản Phẩm Yêu Thích" CssClass="menu-item" OnClick="Wishlist_Click" />
    <asp:Button ID="BtnReviews" runat="server" Text="Đánh Giá Của Tôi" CssClass="menu-item" OnClick="Reviews_Click" />
    <asp:Button ID="BtnCoupons" runat="server" Text="Mã Giảm Giá" CssClass="menu-item" OnClick="Coupons_Click" />
    
    <h2 class="sidebar-section-title">HỖ TRỢ</h2>
    <asp:Button ID="BtnHelp" runat="server" Text="Trung Tâm Hỗ Trợ" CssClass="menu-item" OnClick="Help_Click" />
    <asp:Button ID="BtnFeedback" runat="server" Text="Góp Ý Phản Hồi" CssClass="menu-item" OnClick="Feedback_Click" />
</asp:Content>
